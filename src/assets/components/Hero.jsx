...
import photo from '../images/tousif.jpg'
const Hero = () => {
  return (
<section id="hero" className="flex flex-col md:flex-row items-center justify-between glass-effect p-8 md:px-16 md:py-24">
  ...
  <div className="w-full md:w-1/2 text-center md:text-left mb-8 md:mb-0">
    <h1 className="text-3xl md:text-5xl font-bold text-gray-900 mb-4">
      Hi, I'm <span className="text-blue-700">Tousif Sadeque Chowdhury</span>
    </h1>
    ...
    target="_blank"    
    className="bg-gray-900 text-white py-1 px-3 rounded-lg hover:bg-blue-700 transition duration-300 flex max-w-[120px] w-auto"
  >
