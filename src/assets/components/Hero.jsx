...
<section id="hero" className="flex flex-col md:flex-row items-center justify-between glass-effect p-8 md:px-16 md:py-24">
  ...
  <div className="w-full md:w-1/2 text-center md:text-left mb-8 md:mb-0">
    <h1 className="text-3xl md:text-5xl font-bold text-gray-800 mb-4">
      Hi, I'm <span className="">Tousif Sadeque Chowdhury</span>
    </h1>
    ...
    <a
      href="#about"
      className="inline-block bg-gray-900 text-white py-1 px-3 rounded-lg hover:bg-[#1e22ff] transition duration-300 flex max-w-[120px] w-auto"
    >
